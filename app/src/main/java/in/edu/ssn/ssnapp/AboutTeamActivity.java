...
public class AboutTeamActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void setUpDrawer(){
        ...
        url.add("github.com/pavithrakarumanchi");
        ...
        url.add("www.github.com/nandy20");
        url.add("http://www.linkedin.com/in/nandhini-raja-8b71b4143");
